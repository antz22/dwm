...
//static const char *fonts[]          = { "Source Code Pro Regular:size=21", "Iosevka Nerd Font:pixelsize=26:antialias=true:autohint=true" };
static const char *fonts[]          = { "Terminus:size=20", "Iosevka Nerd Font:pixelsize=26:antialias=true:autohint=true" };
